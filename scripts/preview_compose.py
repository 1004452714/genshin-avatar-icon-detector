...
from avatardetect.config import load_config, project_path
from avatardetect.dataset import AvatarDataset, load_labels, make_mappings


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="生成角色图与背景合成预览")
...
def main() -> None:
    ...
    for idx in range(len(dataset)):
        ...
        out_path = out_dir / f"{idx:03d}_{row['variant_id']}.png"
